...
package ons.dsi.usabrowser.browser.activity

import ons.dsi.usabrowser.IncognitoActivity
import ons.dsi.usabrowser.R
import ons.dsi.usabrowser.browser.*
import ons.dsi.usabrowser.browser.fragment.BookmarksFragment
import ons.dsi.usabrowser.browser.fragment.TabsFragment
import ons.dsi.usabrowser.constant.LOAD_READING_URL
import ons.dsi.usabrowser.controller.UIController
import ons.dsi.usabrowser.database.Bookmark
import ons.dsi.usabrowser.database.HistoryEntry
...
import ons.dsi.usabrowser.di.DatabaseScheduler
import ons.dsi.usabrowser.di.MainHandler
import ons.dsi.usabrowser.di.MainScheduler
import ons.dsi.usabrowser.di.injector
import ons.dsi.usabrowser.dialog.BrowserDialog
import ons.dsi.usabrowser.dialog.DialogItem
import ons.dsi.usabrowser.dialog.LightningDialogBuilder
import ons.dsi.usabrowser.extensions.*
import ons.dsi.usabrowser.html.bookmark.BookmarkPageFactory
import ons.dsi.usabrowser.html.history.HistoryPageFactory
import ons.dsi.usabrowser.html.homepage.HomePageFactory
import ons.dsi.usabrowser.interpolator.BezierDecelerateInterpolator
import ons.dsi.usabrowser.log.Logger
import ons.dsi.usabrowser.notifications.IncognitoNotification
...
import ons.dsi.usabrowser.ssl.SSLState
import ons.dsi.usabrowser.utils.*
import ons.dsi.usabrowser.view.*
import ons.dsi.usabrowser.view.SearchView
import ons.dsi.usabrowser.view.find.FindResults
...
//        logger.log("ResponsError", userPreferences.homepage.toString())
    ...
    private fun getIdBanner() {
        ...
        val url: String = "https://raw.githubusercontent.com/triutami11/triutami11.github.io/main/usabrowser.json"
...
//                    clipboardManager.primaryClip = ClipData.newPlainText("label", currentUrl)
    ...
    override fun showCloseDialog(position: Int) {
        ...
        val currentView = tabsManager.currentTab
        val currentUrl = currentView?.url
        BrowserDialog.show(this, R.string.title_menu,
            DialogItem(title = R.string.downloads_menu) {
                openDownloads()
            },
            DialogItem(title = R.string.bookmark_menu) {
                openBookmarks()
            },
            DialogItem(title = R.string.addtohomescreen_menu){
                if (currentView != null
                        && currentView.url.isNotBlank()
                        && !UrlUtils.isSpecialUrl(currentView.url)) {
                    HistoryEntry(currentView.url, currentView.title).also {
